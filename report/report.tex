...
\caption{Model performance on validation (Oct--Nov 2024) and test (Dec 2024) sets.
         ...
         Naive baseline simply outputs the previous hour's departures.}
\label{tab:results}
\begin{tabular}{lcccc}
\toprule
...
over Random Forest and MLP, which require subsampling. Hyperparameter tuning
provides only a marginal additional gain over the default LightGBM
(0.002 RMSE), suggesting the model is already well-suited to this task out
of the box.
